...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--disable_resolution_free",
        action='store_true',
        help="Disable resolution-free sampling and evaluation"
    )    
    parser.add_argument(
        "--res_free_points",
        type=int,
        nargs='+',  # 여러 개의 정수를 리스트로 받음
        default=[100, 200, 300], # 기본값으로 원하는 리스트 설정
        help="List of point counts for resolution-free validation (e.g., 50 100 200)",
    ) 
