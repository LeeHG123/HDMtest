...
def parse_args_and_config():
    ...
    parser.add_argument(
        "--sample_type",
        default="sde",
        choices=["sde", "ode", "unipc_ode", "dpmpp_ode", "deis_ode", "tsit5_ode", "srk", "pfdiff_ode", None],
        help="sampling method (sde|ode|unipc_ode|dpmpp_ode|deis_ode|tsit5_ode|srk|pfdiff_ode)",
    )
    parser.add_argument(
